...
const experiences = [
  {
    ...
    points: [
      "Developing and maintaining web applications using React Native, React Js, Kotlin and other related technologies.",
  ...
  },
  {
    ...
    company_name: "PT Erloom Digital Venture",
    icon: erloom,
    iconBg: "#383E56",
  ...
  },
  {
    ...
    company_name: "PT Bayu Buana Travel Services",
    icon: bayu_buana,
    iconBg: "#383E56",
  ...
  },
  {
    ...
    company_name: "PT Good game guild",
    icon: ggg,
    iconBg: "#383E56",
  ...
  {
    title: "React Js Develope (Full-time)",
...
export { services, technologies, experiences, testimonials, projects, technologies2, technologiesWeb };
